...
db = mysql.connector.connect(user="root", passwd="T#9758@qlph", host="localhost")
...
db = mysql.connector.connect(user="root", passwd="T#9758@qlph", host="localhost", database='Shop')
my_cursor = db.cursor()
